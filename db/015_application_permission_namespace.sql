-- Application slugs may contain hyphens, while Cove permission identifiers use
-- underscore-separated namespaces. Keep the public slug unchanged and derive a
-- safe internal permission namespace during atomic application provisioning.
...
is 'Auth-owned, idempotent application/User/Admin provisioning primitive. Hyphenated slugs use underscore permission namespaces. Call inside the Systems managed_assets insert statement for atomic registration.';
